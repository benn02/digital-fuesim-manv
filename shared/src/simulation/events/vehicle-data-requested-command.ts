...
export class VehicleDataRequestedCommandEvent implements SimulationEvent {
    @IsValue('vehicleDataRequestedCommandEvent')
    readonly type = 'vehicleDataRequestedCommandEvent';
